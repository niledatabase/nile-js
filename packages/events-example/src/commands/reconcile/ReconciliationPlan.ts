...
export class ReconciliationPlan {
  ...
  constructor(
    ...
    this.destructionIds = Object.keys(stacks)
      .filter((id: string) => id !== null && id !== undefined && !instances[id]);
    this.creationSpecs = Object.values(instances)
      .filter((i: Instance) => i.id !== null && i.id !== undefined && !stacks[i.id]);
  }
}
